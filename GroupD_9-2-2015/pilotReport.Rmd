...
```{r}
setwd("/Users/nickysullivan/Documents/Github/reproducibility_assignment/GroupD_9-2-2015/data/materials-9859-Top-level_materials") #sets the working directory
data_reproduce <- read.csv("12022-Exp1.csv") #and then reads in the data into a table called data_reproduce
```
